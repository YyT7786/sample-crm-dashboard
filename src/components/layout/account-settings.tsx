...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
    /**
     * useForm in Refine is used to manage forms. It provides us with a lot of useful props and methods that we can use to manage
     * https://refine.dev/docs/data/hooks/user-form/#usage
     */
    ...
    const { saveButtonProps, formProps, queryResult } = useForm<
        ...
        HttpError,
        // A third type parameter used to specify the type of variables for the UpdateUserMutation. Meaning that the variables for
        GetVariables<UpdateUserMutationVariables>
    >({
        /**
         * mutationMode is usde to determine how the mutation should be performed. For example, optimistic, pessimistic, undoable etc.
         ...
         * if not specified, Refine will determine the resource name by the current rout
         */
        resource: "users",
        /**
         * specify the action that should be performed on the resource. Behind the scenes, Refine calls useOne hook to get the data
         ...
         */
        meta: {
            // gqlMutation is ued to specify the mutation that should be performed.
