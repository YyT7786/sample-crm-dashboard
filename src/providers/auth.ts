...
export const authProvider: AuthBindings = {
    ...
    onError: async (error) => {
        // a check to see if the error is an authetication error
    ...
    getIdentity: async () => {
        ...
        try {
            ...
            // we'll add some queries and mutations later and change this to User which will be henerated by codegen.
